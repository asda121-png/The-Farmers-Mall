...
// Load Supabase database connection and Google OAuth
  ...
  <div class="modal-content w-full max-w-5xl bg-white rounded-2xl shadow-xl overflow-hidden relative lg:flex" style="min-height: 680px;">
    ...
    <div class="w-full lg:w-1/2 p-8 md:p-16 flex flex-col">
      ...
      <div id="customer-registration-choice" class="flex flex-col justify-center flex-grow">
        ...
        <button type="button" id="googleRegisterBtn" class="w-full bg-white border-2 border-gray-300 text-gray-700 py-3 rounded-lg hover:bg-gray-50 transition duration-150 mb-3 flex items-center justify-center gap-2 font-medium">
          ...
          <span id="googleRegisterBtnText">Continue with Google</span>
        </button>
    ...
    if (googleRegisterBtn) {
      googleRegisterBtn.addEventListener('click', function() {
        ...
        if (googleAuthUrl) {
          ...
          alert('Google authentication is not configured. Please try email registration.');
        }
      });
    }
  });
