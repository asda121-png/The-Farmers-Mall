...
<head>
    ...
    .login-modal {
        ...
        z-index: 100;
        /* Ensure modal is on top of the header */
    ...
    GI .login-modal:not(.hidden) {
        backdrop-filter: blur(4px);
        /* Corresponds to backdrop-blur-sm */
    }
...
?>
  ...
  -->
    <section class="relative flex items-center justify-center min-h-screen pt-[100px] bg-cover bg-center"
        ...
        <div class="relative z-10 w-full max-w-6xl mx-auto px-6">
            ...
            <div class="max-w-lg">
                <h1 id="hero-h1"
                    class="text-6xl font-bold text-white mb-4 opacity-0 translate-y-5 transition-all ease-out duration-700">
                    Your Local Farm,<br>On Your Device</h1>
                <p id="hero-p"
                    class="text-gray-200 text-xl mb-6 opacity-0 translate-y-5 transition-all ease-out duration-700"
                    style="animation-delay: 200ms;">Fresh, local, and organic produce delivered right to your door.</p>
                <a id="hero-a" href="../auth/register.php"
                    class="inline-block px-6 py-3 bg-green-600 text-white font-semibold rounded-full hover:bg-green-700 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg opacity-0 translate-y-5 ease-out duration-700"
                    style="animation-delay: 400ms;">Shop Now</a>
            </div>
        </div>
    </section>
    ...
    <section id="about" class="px-6 py-16 bg-[#f1fbf4] text-center">
        <div class="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow">
            ...
            <p class="text-gray-600">
                At Farmer’s Mall, our mission is to connect local communities with the freshest, highest-quality produce
                from nearby farms. We believe in sustainable agriculture, supporting local economies, and making healthy
                eating accessible to everyone. By cutting out the middlemen, we ensure fair prices for farmers and
                exceptional freshness for you.
            </p>
        </div>
    </section>
    ...
    <section id="how" class="px-6 py-16 text-center">
        ...
        <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-10">
            <div class="bg-white p-6 rounded-xl shadow">
                <img src="https://img.icons8.com/fluency-systems-filled/48/1fa02d/shopping-cart.png"
                    class="mx-auto mb-4" alt="Shop Icon">
                <h3 class="font-bold mb-2">1. Shop</h3>
                <p class="text-gray-600">Browse a wide variety of fresh, seasonal products from local farms on our
                    easy-to-use website.</p>
            </div>
            <div class="bg-white p-6 rounded-xl shadow">
                <img src="https://img.icons8.com/fluency-systems-filled/48/1fa02d/box.png" class="mx-auto mb-4"
                    alt="Pack Icon">
                <h3 class="font-bold mb-2">2. Pack</h3>
                <p class="text-gray-600">Our team carefully selects and packs your order, ensuring every item is fresh
                    and of the highest quality.</p>
            </div>
            <div class="bg-white p-6 rounded-xl shadow">
                <img src="https://img.icons8.com/fluency-systems-filled/48/1fa02d/delivery.png" class="mx-auto mb-4"
                    alt="Deliver Icon">
                <h3 class="font-bold mb-2">3. Deliver</h3>
                <p class="text-gray-600">Your fresh produce is delivered to your doorstep, often on the same day it was
                    harvested!</p>
            </div>
        </div>
    </section>
  ...
  -->
    <section id="shop" class="px-6 py-16 text-center">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-6xl mx-auto mt-10">
            ...
            <a href="../auth/login.php"
                class="group block bg-white rounded-xl shadow overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <a href="../auth/login.php"
                ...
                <img src="../images/meat.png"
                    class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-105" alt="Meat">
    ...
    <section class="px-6 py-16 text-center">
        ...
        <div class="mt-12">
            <a href="../retailer/startselling.php"
    ...
    <section class="px-6 py-16">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <h2 class="text-2xl font-bold text-gray-900 text-center mb-10">Delivery Coverage</h2>
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div class="bg-white p-8 rounded-xl shadow text-center h-full flex flex-col justify-center">
                    <!-- Re-apply the card style here, added flex -->
                    ...
                    <p class="text-gray-600 text-lg">We currently serve areas in and around the <strong>City of
                            Mati</strong></p>
                    ...
                    <p class="mt-8 text-sm text-gray-500">Don't see your area? <a href="support.php"
                            class="text-green-600 hover:underline font-medium">Contact us</a> to let us know where you
                        are!</p>
                </div>
                ...
                <div>
                    <iframe
                        ...
                        referrerpolicy="no-referrer-when-downgrade" class="rounded-xl shadow-lg w-full"></iframe>
                </div>
    ...
    <section class="px-6 py-16">
        <div class="bg-green-600 text-white rounded-xl p-10 text-center max-w-4xl mx-auto">
            ...
            <a href="../public/support.php"
                class="px-6 py-3 bg-white text-green-700 font-semibold rounded-full hover:bg-gray-200 transition">Get
                Help</a>
        </div>
    </section>
