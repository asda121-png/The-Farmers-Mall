...
<head>
  ...
  <!-- PayPal SDK -->
  <script
    src="https://www.paypal.com/sdk/js?client-id=Acrpz8PXXG3uTexf1Ap9c7ADDza2qxiuyRfbM8O9AVbM_qJ0dAZ7SBEFrXnNziKGCjmbIcToiNbcbQqj&currency=PHP">
  </script>
  ...
  <main class="max-w-7xl mx-auto p-6 flex flex-col lg:flex-row gap-8 mt-6 flex-grow w-full mb-20">
    ...
    <section class="flex-1 bg-white p-6 rounded-xl shadow-sm min-h-[400px]">
      ...
      <div class="space-y-3 mb-6">
        <!-- Card -->
        <label
          class="flex items-center justify-between border rounded-lg p-4 cursor-pointer hover:border-green-500">
        ...
        <label
          class="flex items-center justify-between border rounded-lg p-4 cursor-pointer hover:border-green-500">
          <div class="flex items-center gap-3">
            <input type="radio" name="payment" value="gcash" class="accent-green-600">
    ...
    <aside class="bg-white shadow-sm p-6 rounded-xl w-full lg:w-80 h-fit">
      ...
      <div id="orderItems" class="space-y-3 mb-4">
        ...
        ?>
          <div class="flex gap-3">
            ...
            <div class="text-sm font-semibold text-gray-700">₱<?php echo number_format($item['subtotal'], 2); ?>
            </div>
          </div>
        <?php endforeach; ?>
      </div>
      ...
      <div class="text-sm text-gray-700 space-y-2">
        <div class="flex justify-between"><span>Subtotal</span><span
            id="subtotal">₱<?php echo number_format($subtotal, 2); ?></span></div>
        <div class="flex justify-between"><span>Shipping</span><span>Free</span></div>
        <div class="flex justify-between text-xs text-gray-500"><span>Tax (estimated 12%)</span><span
            id="tax">₱<?php echo number_format($tax, 2); ?></span></div>
      </div>
      ...
      <!-- GCash Button Container (hidden by default) -->
