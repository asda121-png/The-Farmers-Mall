            ...
            fetch('../api/get-retailer-finance.php')
                ...
                .then(data => {
                    if (data.success && data.financeData) {
                        ...
                        document.getElementById('totalRevenue').textContent = '₱' + Number(finance.totalRevenue).toLocaleString('en-PH', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                        });
                        document.getElementById('thisWeekRevenue').textContent = '₱' + Number(finance.thisWeekRevenue).toLocaleString('en-PH', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                        });
                        document.getElementById('thisMonthRevenue').textContent = '₱' + Number(finance.thisMonthRevenue).toLocaleString('en-PH', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                        });
