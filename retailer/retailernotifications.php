    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      const getIconForType = (type) => {
        switch (type) {
          case 'order':
            return {
              icon: 'fa-box', color: 'green'
            };
          case 'order_cancelled':
            return {
              icon: 'fa-ban', color: 'red'
            };
          case 'stock':
            return {
          ...
          case 'review':
            return {
              icon: 'fa-star', color: 'blue'
            };
          case 'message':
            return {
              icon: 'fa-comment-dots', color: 'purple'
            };
          case 'payment':
            return {
              icon: 'fa-credit-card', color: 'teal'
            };
          default:
            return {
              icon: 'fa-bell', color: 'gray'
            };
        }
      };
