    ...
    <div class="flex flex-col min-h-screen">
        ...
        <script type="module">
            ...
            reviews = [{
                    ...
                    rating: 5,
                    feedback: 'Absolutely fresh and delicious! Perfect crunch.',
                    date: '2024-10-01',
                    response: ''
                },
                {
                    ...
                    rating: 2,
                    feedback: 'Loaf was stale and crust was too hard. Disappointed.',
                    date: '2024-10-03',
                    response: ''
                },
                {
                    ...
                    productName: 'Organic Gala Apples',
                    rating: 4,
                    feedback: 'Great, but a little smaller than expected.',
                    date: '2024-10-05',
                    response: 'Thank you for your feedback! We are working on grading our produce more accurately. We hope to earn 5 stars next time!'
                }
            ];
            ...
            window.handleBulkPriceSubmit = async (event) => {
                ...
                const updates = products
                    ...
                    .map(p => {
                        ...
                        return updateDoc(doc(db, getCollectionPath('products'), p.id), {
            ...
            function renderDashboard() {
                ...
                const kpiData = [{
                        ...
                        icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2M9 14h6m-5 4h4'
                    },
                    {
                        title: 'New Orders',
                        value: newOrders,
                    ...
                    {
                        title: 'Top 3 Sellers',
                        value: topProducts || 'N/A',
                        icon: 'M19 11H5m14 0V9m0 2v2m-4-2h1m-1 0h-2m2 0v2m-2-2h-1m-1 0H5m-2 4h18'
                    },
                ];
                ...
                if (orders.length === 0 && firebaseConfig) {
                    ...
                    const mockOrders = [{
                        ...
                        },
                        {
                            ...
                            status: 'Processing',
                            createdAt: serverTimestamp(),
                            deliveryAddress: '456 Oak Ave, Cityville',
                            items: [{
                                name: 'Local Sweet Potatoes',
                                quantity: 5,
                                price: 5.00
                            }]
                        },
            ...
            window.onload = () => {
                ...
                products = [{
                        ...
                        uom: 'lb',
                        status: 'Active',
                        imageUrl: 'https://placehold.co/40x40/991b1b/ffffff?text=A'
                    },
                    {
                        id: 'p2',
                        ...
                        uom: 'loaf',
                        status: 'Active',
                        imageUrl: 'https://placehold.co/40x40/654321/ffffff?text=B'
                    },
                    {
                        id: 'p3',
                        name: 'Local Sweet Potatoes',
                        ...
                        uom: 'kg',
                        status: 'Active',
                        imageUrl: 'https://placehold.co/40x40/f97316/ffffff?text=P'
                    },
                    {
                        id: 'p4',
                        ...
                        uom: 'unit',
                        status: 'Active',
                        imageUrl: 'https://placehold.co/40x40/047857/ffffff?text=M'
                    },
                ];
                orders = [{
                        id: 'o1',
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (ctx) {
                    ...
                    document.getElementById('totalSalesAmount').textContent = '₱' + totalSales.toLocaleString('en-PH', {
