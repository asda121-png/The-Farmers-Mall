    ...
    <nav>
      <ul class="flex gap-6"> <!-- Removed default text color, script will handle it -->
        <!-- ✅ CHANGED: Updated links to work from any page -->
         ...
         <li><a href="../public/index.php" class="hover:text-green-700">Home</a></li>
      <li><a href="../public/about.php" class="hover:text-green-700">About</a></li>
      <li><a href="../public/how.php" class="hover:text-green-700">How It Works</a></li>
      <li><a href="../public/support.php" class="hover:text-green-700">Support</a></li>

      </ul>
    </nav>

    <div class="flex gap-3 mr-[96px]">
      <a href="auth/login.php" class="px-4 py-2 border-2 border-green-600 text-green-600 font-semibold rounded-full hover:bg-green-600 hover:text-white transition">
        Login
      </a>
